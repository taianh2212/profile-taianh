      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            <div 
              className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-10"
              style={{
                gridAutoFlow: 'dense', // Tự động di chuyển ảnh để lấp đầy khoảng trống
                gridAutoRows: 'auto'
              }}
            >
              {/* Cover Image */}
